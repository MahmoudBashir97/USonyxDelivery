 ...
 * Use the [HomeDeliveryOrdersFragment.newInstance] factory method to
...
class HomeDeliveryOrdersFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment HomeDeliveryOrdersFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HomeDeliveryOrdersFragment().apply {
